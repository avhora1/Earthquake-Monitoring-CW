...
<head>
    ...
    <style>
        ...
        .carousel-wrap {
            ...
            width: 100vw;
            position: relative;
            gap: 14px; /* Space between arrow and shelves container */
        }
        .carousel-arrow {
            background: #292c45;
            color: #fff;
        ...
        .label-a { margin-left: 3px; }
        .label-z { margin-right: 3px; }
        ...
        @media (max-width:700px) {
            .carousel-header { width: 97vw; max-width: 97vw; margin: 50px 0 14px 0;}
            .shelves-viewport { width: 99vw; min-width: 0; height: 220px; padding-bottom: 22px;}
            .shelf { min-width: 80px; max-width: 80px;}
            .shelf-grid { grid-template-columns: repeat(3, 20px); grid-template-rows: repeat(3, 20px); gap: 4px;}
            .slot { width: 20px; height: 20px;}
            .carousel-arrow { width: 18px; height: 18px; font-size: 1.2rem;}
            .shelf-slider { width: 65px; height: 10px; bottom: 3px;}
            .label-a, .label-z { font-size: 0.9rem; }
...
<body>
    ...
    <script>
        ...
        function afterShelfChange() { updateSliderDot(); }
        ...
        sliderBar.addEventListener('touchstart', startScrub, { passive: false });
        sliderDot.addEventListener('touchstart', startScrub, { passive: false });
