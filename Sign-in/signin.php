...
.earth img { position: absolute; top: 20vh; right: 10vw; z-index: -1; width: 80vh; height: 80vh;}
.crack img { position: absolute; top: 6vh; left: 12vw; z-index: 2; width: auto; height: 15vh;}
.glass-box {
    background: linear-gradient(153deg, rgba(255,255,255,0.20) 0%, rgba(255,255,255,0.00) 100%);
    border: 2px solid rgba(255,255,255,0.09); backdrop-filter: blur(1vh);
    border-radius: 2rem; min-height: 80vh; top: 20vh; box-shadow: 0 4px 32px 0 rgb(0 0 0/10%);
    padding-left: 4.5vh; padding-right: 4.5vh;
}
.glass-box h1 {
    font-family: 'Roboto', Arial, sans-serif; padding-top: 8vh; font-size: 6vh;
    font-weight: 900; color: #FF7400; margin-bottom: 20px;
}
.glass-box p { padding-right: 3vh; color: #fff; padding-bottom: 1vh; font-weight: 400; font-size: 1.3rem; }
.login-logo { display: block; padding-top: 6vh; width: 20vh; margin-left: auto; margin-right: auto; }
...
.glass-box input::placeholder { color: #fff; opacity: 1; }
...
.show-password-btn:focus { outline: 2px solid #ff9100; }
.login-btn {
    display: block;
    width: 70%;
...
.login-btn:hover { background: linear-gradient(90deg, #ffbe3d, #ff9100); box-shadow: 0 0 32px #fa8c16bb;}
.login-signup-message { text-align: center; margin-top: 10px; color: #fff; font-size: 1rem; position: absolute; bottom: 2vh; left: 0; right: 0; margin-bottom: 6px;}
.login-signup-message a { color: #ff9100; text-decoration: underline;}
</style>
</head>
<body>
    <div class="crack">
                ...
                <div class="glass-box">
                    ...
                    <form style="margin-top:10px;text-align:left;" action="" method="post" autocomplete="off">
                        ...
                        <div class="input-wrap">
                            ...
                            <button type="button" class="show-password-btn" id="showPwBtn"
                                    onclick="togglePw()" tabindex="-1" aria-label="Show/Hide password">
                                <i class="bi bi-eye"></i>
                            </button>
                        </div>
...
document.getElementById('password').addEventListener('blur', function() {
    var btn = document.getElementById('showPwBtn');
    if (this.value.length === 0) btn.style.display = "block"; // stay visible, or hide if you prefer with "".
});
function togglePw() {
