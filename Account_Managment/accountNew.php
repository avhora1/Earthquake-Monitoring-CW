...
<head>
    ...
    <style>
        ...
        .account-actions-form input[type="password"], .account-actions-form input[type="text"] {
        ...
        .account-actions-form input[type="password"]:focus, .account-actions-form input[type="text"]:focus {
            border-color: #ff9100;
        }
        .pwreq-list, #pwreq-list {
            margin:8px 0 0 0; 
            padding-left:0; 
            font-size:0.97em; 
            line-height:1.4; 
        ...
        <div class="form-section">
            ...
            <form class="account-actions-form" method="post" autocomplete="off">
                <div>
                    ...
                    <input type="text" id="new_username" name="new_username" value="" placeholder="New username (unique)" required autocomplete="off">
                </div>
        ...
        <div class="form-section">
            ...
            <form class="account-actions-form" autocomplete="off" method="post" id="changePasswordForm">
                <div>
                    ...
                    <input type="password" name="password" id="password" required minlength="8" autocomplete="new-password" oninput="checkPasswordStrength()" style="margin-bottom:0;">
                    <ul id="pwreq-list">
...
function checkPasswordStrength() {
    ...
    let reqs = [
        ...
        { regex: /[a-z]/, id: 'req-lower' },
        { regex: /[0-9]/, id: 'req-digit' },
        { regex: /[\W_]/, id: 'req-special' }
    ];
    let strength = 0;
